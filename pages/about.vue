    ...
    <div class="container">
      <div class="article">
        <div class="article__content">
          <h1>Заряжайте будущее с Ecolink!</h1>

          <p>
            Мы устанавливаем зарядные станции для электромобилей бизнесу и
            частным лицам по всей России — быстро, надёжно и с гарантией.
          </p>

          <p>
            С 2012 года мы помогаем сделать электромобили ещё удобнее. Только за
            последние 3 года:
          </p>

          <ul>
            <li>
              смонтировали более 200 мощных станций для коммерческих объектов;
            </li>
            <li>
              оснастили множеством компактных установок частные дома и парковки.
            </li>
          </ul>
          ...
          <div>
            <h3><strong>Всё под ключ.</strong></h3>
            <p>
              Не нужно искать подрядчиков: мы берём на себя подбор, поставку,
              монтаж и запуск станции.
            </p>
          </div>

          <div>
            <h3><strong>Сервис без хлопот.</strong></h3>
            <p>Техническое обслуживание и ремонт — наша забота.</p>
          </div>

          <div>
            <h3><strong>Быструю окупаемость.</strong></h3>
            <p>
              Благодаря прямым контрактам с заводами Китая и знанию российского
              рынка мы предлагаем лучшее соотношение цены и качества.
            </p>
          </div>

          <div>
            <h3><strong>Оперативность в любом городе.</strong></h3>
            <p>
              География наших услуг охватывает всю Россию — мы быстро реагируем
              и выполняем работы точно в срок.
            </p>
          </div>

          <p>Выбирайте надёжность и комфорт — выбирайте Ecolink!</p>
        </div>
...
useHead({
  ...
  meta: [
    {
      name: "keywords",
      content: "о компании Eco-link",
    },
    {
      name: "description",
      content:
        "Более 200 крупных и множество небольших зарядных станций для электромобилей установлено за последние 3 года.",
    },
    {
      property: "og:title",
      content: "EL — О компании",
    },
    {
    ...
    { property: "og:image", content: "/images/main-promo.jpg" },
  ],
});
...
function onShareClick() {
  share("EL", "EL", "/images/main-promo.jpg");
}
</script>
