      ...
      <div class="container">
        <div class="main-promo__row">
          <div class="main-promo__left">
            ...
            <h1>Пространство и организация мероприятий в Москве</h1>
            <p>
              Предоставляем полный спектр услуг, начиная от создания концепции и
              планирования, до тщательной реализации и координации деталей.
              Проводим более 50 событий на 6 000+ участников в год
            </p>
            <UITheButton
              title="Узнать цены"
          ...
          >
            <img
              ...
              alt="Пространство для мероприятий в Москве"
            />
          </div>
        </div>
      </div>
    ...
    <section class="st-section slider">
      <div class="container">
        <UITheSectionTitle
          ...
          :video="'https://rutube.ru/play/embed/da36335391b54b0eaf0d75c7948ce06d/'"
          @showVideo="showVideo"
        ></UITheSectionTitle>
        <TheSwiperPage
          :uniqueId="'solutions'"
      ...
      <div class="container">
        <div class="info-block__row">
          <div class="info-block__text">
            <UITheSectionTitle
              :title="'Оставьте заявку, наши менеджеры свяжутся с вами'"
              :subtitle="'Вы получите не просто смету, а решение, которое позволит провести мероприятие и/или съёмки на высшем уровне и получить необходимый результат. Для вас комфортные цены и лучшее оснащение.'"
...
useHead({
  title: "Vlada Group — площадки для мероприятий в Москве. м. Авиамоторная.",
  meta: [
    {
      name: "keywords",
      content: "аренда площадки для мероприятий, аренда площадки для съемок",
    },
    {
      name: "description",
      content:
        "Просторный, но компактный павильон, чтобы не ограничивать себя и не переплачивать за лишние метры.",
    },
    {
      property: "og:title",
      content:
        "Vlada Group — площадка для мероприятий и съемок в Москве. м. Авиамоторная.",
    },
    {
...
const rentSubtitle =
  "Если ваше мероприятие предполагает съемки, то у нас всё есть для их проведения. Внушительный парк техники для получения контента уровня кино и дорогой рекламы.";
...
const solutionsTitle = "Познакомьтесь с нашими кейсами";
const solutionsSubtitle =
  "Мы организовываем и проводим события разного масштаба — от корпоративных мероприятий до крупных конференций";
const solutionsItems = [
  {
    id: 1,
    title: "Деловые мероприятия",
    image: "/images/event/business.jpg",
    text: "Семинары и небольшие конференции для своих",
  },
  {
    id: 2,
    title: "Масштабные конференции",
    image: "/images/event/rybakov.jpg",
    text: "Грандиозные шоу на тысячи участников",
  },
  {
    id: 3,
    title: "Корпоративы",
    image: "/images/event/corporativ.jpg",
    text: "Праздник с размахом, когда хочется отблагодарить свою команду",
  },

  {
    ...
    text: "Проведем все на высшем уровне, и ваши смыслы достигнут адресатов",
  },

  {
    id: 5,
    title: "Шоу",
    image: "/images/event/show.jpg",
    text: "События топ-уровня с выступлениями спикеров, артистов, исполнителей",
  },

  {
    id: 6,
    title: "Кинопоказы",
    image: "/images/event/cinemashow.jpg",
    text: "От масштабных до камерных с незабываемой атмосферой",
  },

  {
    id: 7,
    title: "Подкаст-шоу",
    image: "/images/event/podcast.jpg",
    text: "Подкасты с экспертами в жанре шоу",
  },
];
...
const featuresTitle = "Дополнительно";
const featuresSubtitle =
  "Мы готовы профессионально сопроводить ваше мероприятие. Вам доступен персональный менеджер, а также ряд дополнительных возможностей.";
const featuresItems = [
  {
    id: 1,
    title: "Услуги продюсера, креативной команды и event-менеджеров",
    text: "Многолетний опыт в индустрии и отличные кейсы",
    image: "/images/features/features3-2.jpg",
  },
  {
    id: 2,
    title: "Режиссер, оператор и техкоманда",
    text: "Наш многолетний опыт в кино‑рекламе позволяет задействовать проверенные ресурсы",
    image: "/images/features/features1.jpg",
  },
  {
    id: 3,
    title: "Услуги клининга",
    text: "Мы сами приведем в порядок помещения до и после мероприятия",
    image: "/images/features/cleaning.jpg",
  },
  {
    id: 4,
    title: "Кейтеринг",
    text: "Учтем пожелания организаторов и гостей, реализуем всё по высшему разряду",
    image: "/images/features/catering.jpg",
  },
];

const ledTitle = "LED-экраны в аренду для мероприятий";
const ledSubtitle =
  "Если ваше событие требует большей визуализации и спецэффектов - мы предоставляем экраны с монтажом и установкой на вашей площадке";
const ledItems = [
  {
    id: 1,
  ...
  },
  {
    id: 3,
    title: "Контент с LED",
    text: "Создавайте масштабные события с виртуальной реальностью",
...
const videoMain =
  "https://rutube.ru/play/embed/bdac1a4ca13b8c13ac6987ff70ce77ba/";
const video = ref("");
...
const breadcrumbs = [
  { title: "Главная", link: "/" },
  { title: "Пространство и организация мероприятий в Москве", link: "" },
];
