    ...
    <div class="container">
      <div class="article">
        <div class="article__content">
          ...
          безопасности персональных данных, предпринимаемые ИП Светличный Юрий
          Сергеевич, ИНН: 500715196517, ОГРН/ОГРНИП: 314500730400037, адрес:
          141800 МО, г. Дмитров, ул. Трансформаторная, д.19 (далее –
          Оператор).<br />1.2. Оператор ставит своей важнейшей целью и условием
          ...
          прав на неприкосновенность частной жизни, личную и семейную тайну.<br />1.3.
          ...
          посетителях веб-сайта https://zaryadki-el.ru/ (далее – Сайт).<br /><br />2.
          ...
          адресу https://zaryadki-el.ru/.<br />2.4. Информационная система
          ...
          https://zaryadki-el.ru/.<br />2.9. Пользователь – любой посетитель
          веб-сайта https://zaryadki-el.ru/.<br />2.10. Предоставление
          ...
          сайте https://zaryadki-el.ru/. Заполняя соответствующие формы и/или
...
useHead({
  title: "EL — Политика конфиденциальности",
  meta: [
    {
      name: "keywords",
    ...
    {
      property: "og:title",
      content: "EL — Политика конфиденциальности",
    },
    {
